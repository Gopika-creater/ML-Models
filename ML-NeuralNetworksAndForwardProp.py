...
def small_network(num_inputs, num_hidden_layers, num_nodes_hidden, num_nodes_output):
    ...
    return network # return the networ
print(small_network(5,3,[3,2,3],1))
...
def small_network(num_inputs, num_hidden_layers, num_nodes_hidden, num_nodes_output):
    ...
    return network # return the networ
network = small_network(5, 3, [3, 2, 3], 1)
...
my_network = small_network(5, 3, [2, 3, 2], 3)
inputs = np.around(np.random.uniform(size=5), decimals=2)
